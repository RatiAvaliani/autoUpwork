                                            ...
                                            <tr>
                                                <td width="560" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td class="es-p15b" align="center"><h2>Welcome To Seeup!</h2></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="es-p20t" align="center"><h4>Verify Email</h4></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="es-p20t" align="left">
                                                                <p>
                                                                    Using this link you can verify you email and use some of the functions on the
                                                                    web page with is blocked.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr class="es-p20t" align="center">
                                                            <td>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="560" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td class="es-infoblock" align="center" style="font-size: 0px"><a target="_blank" href="http://viewstripo.email/?utm_source=templates&utm_medium=email&utm_campaign=basic&utm_content=one_column"><amp-img src="https://hmhywo.stripocdn.email/content/guids/CABINET_e470d4016281902e0b9633f1a428c3bd/images/33421599755739108.PNG" alt width="125" style="display: block" height="49"></amp-img></a></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                            </table></td>
