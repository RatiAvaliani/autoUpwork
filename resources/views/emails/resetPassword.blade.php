                                            ...
                                            <tr>
                                                <td width="560" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td class="es-p15b" align="center"><h2>Password reset!</h2></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="es-p20t" align="left">
                                                                <p>
                                                                    You have requested password reset <a href="{{ $link }}">Click Here</a>.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="es-p20t" align="left">
                                                                <p>If you have not requested a password reset, you need to change the password and contact support@seeup.com</p>
                                                            </td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
